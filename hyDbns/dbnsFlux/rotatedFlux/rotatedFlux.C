...
) const
{
  ...
  {
      scalar rhoFlux1, rhoFlux2, rhoEFlux1, rhoEFlux2, rhoEvFlux1, rhoEvFlux2;
      ...
      diffusiveFlux_->evaluateFlux(rhoFlux1, rhoUFlux1, rhoEFlux1, rhoEvFlux1, pLeft, pRight, ULeft, URight, TLeft, TRight, evLeft, evRight, RLeft, RRight, CvtLeft, CvtRight, CvrLeft, CvrRight, n1*magSf, magSf);

      vector n2 = (n1^n)^n1;
      n2 /= mag(n2);

      lowDiffusionFlux_->evaluateFlux(rhoFlux2, rhoUFlux2, rhoEFlux2, rhoEvFlux2, pLeft, pRight, ULeft, URight, TLeft, TRight, evLeft, evRight, RLeft, RRight, CvtLeft, CvtRight, CvrLeft, CvrRight, n2*magSf, magSf);
      ...
      rhoEvFlux = alpha1*rhoEvFlux1 + alpha2*rhoEvFlux2;
  }
  else
  {
      // According to Nishikawa, n1 is othogonal to n (i.e. alpha1=0)
      lowDiffusionFlux_->evaluateFlux(rhoFlux, rhoUFlux, rhoEFlux, rhoEvFlux, pLeft, pRight, ULeft, URight, TLeft, TRight, evLeft, evRight, RLeft, RRight, CvtLeft, CvtRight, CvrLeft, CvrRight, Sf, magSf);
  }

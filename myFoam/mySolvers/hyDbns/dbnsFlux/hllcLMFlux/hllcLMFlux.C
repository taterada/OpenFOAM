...
) const
{
  ...
  //  };
    ...
    - rhoLeft*qLeft*(SLeft - qLeft) + pLeft - pRight ) / stabilise((rhoRight*(SRight-qRight)-rhoLeft*(SLeft-qLeft)),VSMALL);
    ...
    else if (pos(SStar))
    {
        ...
        rhoEvState = omegaLeft*(SLeft - qLeft)*rhoEvLeft;
    ...
    else if (pos(SRight))
    {
        ...
        rhoEvState = omegaRight*(SRight - qRight)*rhoEvRight;
    ...
    rhoEvFlux = (convectionSpeed*rhoEvState)*magSf;
}
